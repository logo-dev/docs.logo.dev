...
description: "Migration guide from the Clearbit Logo API to Logo.dev. A one-to-one replacement built by the same team, with better features and transparent pricing."
keywords:
  [
    "clearbit migration",
    "clearbit logo api",
