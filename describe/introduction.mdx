...
description: "Brand API returns company logos and data from domains. Get company logos, colors, social links via Logo API. Secret key auth, JSON response. Try free."
---
...
Unlike the publishable key, it's your responsibility to keep your secret key safe and away from public eyes. Even during testing, please never publish to Github or allow it to be seen from front-end code.

If your secret key is ever leaked, please get in touch immediately so we can regenerate a new one for you.
