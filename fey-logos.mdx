...
<AccordionGroup>
  ...
  <Accordion title="Can I use archived Fey Logos in my project?">
    Even if you find archived versions, logos are trademarks of their owners.
    Use must comply with each brand's guidelines. For commercial projects,
    migrate to Logo.dev for proper licensing and reliability.
  </Accordion>
