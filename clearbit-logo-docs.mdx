...
description: Official reference for the deprecated Clearbit Logo API, including endpoint parameters, code examples, shutdown details, and migration guidance to Logo.dev.
keywords:
  - Clearbit logo API
  - Clearbit logo
