...
```html Format
<img
  src="https://img.logo.dev/ticker/:symbol?token=:public_token"
...
<img
  src="https://img.logo.dev/ticker/AAPL.LSE?token=:public_token"
...
<img
  src="https://img.logo.dev/ticker/7203.JPX?token=:public_token"
...
<AccordionGroup>
  ...
  <Accordion title="What if I find a missing or wrong ticker logo?">
    ...
    update at [logo.dev/update](https://www.logo.dev/update) - Report directly
    from the dashboard when you're logged in
  </Accordion>
</AccordionGroup>
