...
<img src="https://img.logo.dev/ticker/AAPL?token=:public_token" />
```

```html London Stock Exchange
<img src="https://img.logo.dev/ticker/AAPL.LSE?token=:public_token" />
```

```html Tokyo Stock Exchange
<img src="https://img.logo.dev/ticker/7203.JPX?token=:public_token" />
```
