...
description: "Logo API for company logos via simple image URLs. Get brand logos in SVG, PNG, WebP formats. High uptime, global servers. Public key auth. Try free."
---
...
Our image CDN will resize to any valid integer, but we recommend staying under 600px when using raster images like `jpg` and `png`. There is a max size of 800px and any sizes above that will be clipped to 800px.
