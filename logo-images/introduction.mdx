...
```html
<img src="https://img.logo.dev/ticker/ESTC" />
```

<Frame caption="https://img.logo.dev/ticker/ESTC">
  <img
    alt=""
    width="128"
    height="128"
    src="https://img.logo.dev/ticker/ESTC?token=live_6a1a28fd-6420-4492-aeb0-b297461d9de2"
  />
</Frame>

<Warning>
  Ticker symbols of NYSE and NASDAQ are currently supported.{" "}
  <a href="mailto:team@logo.dev">
    Get in touch at team@logo.dev if you want additional exchanges.
  </a>
</Warning>
