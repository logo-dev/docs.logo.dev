...
<CodeGroup>
```html Example
<img src="https://img.logo.dev/crypto/eth?token=:publishable_key" />
```

```html Format
<img src="https://img.logo.dev/crypto/:symbol?token=:publishable_key" />
```
...
<Note>
  ...
  us](mailto:team@logo.dev?subject=Crypto%20Logos) with your requirements.
</Note>
