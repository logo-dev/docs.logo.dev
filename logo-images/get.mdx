---
title: "Get company logos by domain"
sidebarTitle: "Domain Logos"
description: "Company logos API parameters guide. Control logo size, format (PNG/JPG/WebP), theme options. Logo API with publishable key auth. Full documentation."
---
...
<ParamField path="fallback" type="string" default="monogram">
  ...
  <Expandable title="options">
    ...
    <ResponseField name="404">
      ...
      images](/logo-images/introduction#fallback-images).
    </ResponseField>
  </Expandable>
