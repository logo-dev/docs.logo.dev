...
description: Complete guide to Google's unofficial s2 favicon API for retrieving website icons by URL, with size parameters, usage examples, and known limitations.
keywords:
  - Google favicon API
  - Google favicon
  - favicon API
