...
description: "Display company logos in Excel spreadsheets using Logo.dev's API. Works with IMAGE function, headers, footers, and VBA. Compatible with Excel 365, 2019, and Excel Online."
keywords:
  [
    "excel logo",
    "add logo to excel",
