...
description: "Display company logos in Excel spreadsheets using Logo.dev. Works with the IMAGE function, headers, footers, and VBA in Excel 365, 2019, and Online."
keywords:
  [
    "excel logo",
    "add logo to excel",
