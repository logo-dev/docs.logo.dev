...
<Frame caption="https://logo.dev/sweetgreen.com">
  <img
    ...
    width="128"
    height="128"
    src="https://img.logo.dev/sweetgreen.com?size=256&format=png"
  />
</Frame>
...
```html
<img
  src="https://logo.dev/microsoft.com?token=YOUR-KEY-HERE&size=200&format=png"
/>
```
...
<Frame caption="https://logo.dev/microsoft.com">
  <img
    ...
    width="200"
    height="200"
    src="https://img.logo.dev/microsoft.com?size=200&format=png"
  />
</Frame>

## Getting an API key

You'll be required to add an `?token=` parameter with an API key to do any serious querying of logos. You can get one for free by signing up at [www.logo.dev](https://www.logo.dev).
