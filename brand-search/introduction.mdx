...
description: "Search for company domains by brand name. Get autocomplete results with typeahead or exact matching. Coverage for tens of millions of companies."
---
...
<Tip>
  Use `strategy=match` when you have near-complete names and need exactness;
  keep `typeahead` for live search UX.
</Tip>
