...
description: "Logo.dev fair use policy and acceptable use guidelines. Learn what's allowed, best practices, and how to stay compliant while building with our logo API."
keywords:
  [
    "fair use",
    "usage policy",
...
- **Reasonable caching**: Follow our [caching guidelines](/platform/caching)
